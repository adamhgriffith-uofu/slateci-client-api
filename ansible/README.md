...
* SSH'ing is now very simple (see the **API SSH Commands** section for additional information in the primary [README](../README.md)).
...
* Follow the instructions at the top of `/ansible/templates/fabric/make-hosts-yaml.py` in this repository.

Next create the cluster noting it may take several minutes to complete.
